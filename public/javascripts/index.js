(function() {
    ...
    function translatePoints(data, dfd){
        ...
        for (let i=0; i<data.sketchEntities.length; i++)
        {
            ...
            if (i>0)
            {
                line.position.x = data.sketchEntities[i-1].tessellationPoints[data.sketchEntities[i].tessellationPoints.length-1][0];
                line.position.y = data.sketchEntities[i-1].tessellationPoints[data.sketchEntities[i].tessellationPoints.length-1][1];
                line.position.z = data.sketchEntities[i-1].tessellationPoints[data.sketchEntities[i].tessellationPoints.length-1][2];
            }
